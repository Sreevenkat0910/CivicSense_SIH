...
export function LoginPage({ onLogin }: LoginPageProps) {
  ...
  const handleLogin = () => {
    ...
    if (!user) {
      alert("Invalid credentials. Try admin/admin, public/public, water/water, ravie/ravie, or mandal/mandal");
      return;
    }
        ...
        <div className="space-y-6">
          ...
          <div className="text-center pt-4 border-t">
            ...
            <div className="space-y-2">
              ...
              <div className="flex items-center justify-between text-xs">
                <Badge variant="secondary" className="bg-amber-50 text-amber-700">Department Employee</Badge>
                <span className="text-muted-foreground">ravie / ravie</span>
              </div>
              <div className="flex items-center justify-between text-xs">
